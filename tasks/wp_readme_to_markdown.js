 ...
 grunt.registerMultiTask('wp_readme_to_markdown', 'Converts WP readme.txt file to markdown (readme.md)', function() {
	...
	this.files.forEach(function(f) {
		...
		if ( '' !== options.travisUrlRepo ) {
			addToHeaderArray.push( '[![Build Status](' + options.travisUrlRepo + '.svg?branch=' + options.travisBranch + ')](' + options.travisUrlRepo + ')' );
		}

		if ( '' !== options.coverallsRepo ) {
			addToHeaderArray.push( '[![Coverage Status](https://coveralls.io/repos/github/' + options.coverallsRepo + '/badge.svg?branch=' + options.coverallsBranch + ')](https://coveralls.io/github/' + options.coverallsRepo + '?branch=' + options.coverallsRepo + ')' );
		}
